                ...
                <div class="form col-md-6 contact-form wow fadeInRight col-md-offset-3" data-wow-duration="1.5s" data-wow-offset="10">
				 ...
				 <form id="#" class="form-horizontal" action="#" method="post">
				   ...
				   <div class="form-group">
					  ...
					  <input class="form-control" type="text" name="" placeholder="Ex: Mr./Ms./Mrs " value="" / required>
					 </div>
                    </div>
					<div class="form-group">
                      <div class="col-sm-12">
					  	   <label for="sel1">Name:</label>
					  <input class="form-control" type="text" name="" placeholder="Enter name" value="" / required>
					 </div>
                    </div>
					<div class="form-group">
                      <div class="col-sm-12">
					   <label for="sel1">Address for Correspondence:</label>
					  <textarea class="form-control" type="text" name="" placeholder="Enter Address for Correspondence:" value="" / required></textarea>
					 </div>
                    </div>
					<div class="form-group">
                      <div class="col-sm-12">
					  <label for="sel1">Mobile No:</label>
					  <input class="form-control" type="text" name="" placeholder="Enter Mobile No" value="" / required>
					 </div>
                    </div>
                    ...
                    <div class="form-group">
					  ...
					  <input class="form-control" type="mail" name="" placeholder="Enter Email" value="" /required>
					...
					<div class="form-group">
					  ...
					  <textarea class="form-control" type="text" name="" placeholder="Enter College/Institution Name and Address" value="" / required></textarea>
					 </div>
                    </div>
					  <div class="form-group">
                      <div class="col-sm-12 ">
					  <label for="sel1">Amount INR: </label>
					  <input class="form-control" type="text" name="" value="₹ 5000"/ disabled>
				     <span style="color:red;">	</span>
				   </div>
                    </div>
